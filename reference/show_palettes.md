...
#> 
#> $Chinese
#> [1] "#1772B4" "#0AA344" "#F9BD10" "#F97D1C" "#ED5736" "#D70440" "#5976BA"
#> [8] "#8076A3"
#> attr(,"type")
#> [1] "discrete"
#> 
...
#> Error in show_palettes(palette_names = c("Chinese_red", "Chinese_blue"),     return_palettes = TRUE): Can not find the palettes: "Chinese_red" and "Chinese_blue"
```
